...
/// 处理文档 objectid
/// [`doc`] 需要处理ObjectId 的文档
/// [`ids`] 需要处理的ObjectId
///
/// # Example
/// ```rust
/// let doc = doc! {"_id":"ObjectID('6051fca3d62493000fa99760')"};
/// let doc = document_handle_id(doc,Some(vec!["_id"]));
/// assert_eq!(doc!{"_id":"6051fca3d62493000fa99760"},doc);
/// ```
#[inline]

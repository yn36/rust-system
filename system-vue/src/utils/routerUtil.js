...
/** 从路由 解析 i18n 名称 */
function getI18n(menu, lang) {
  if (menu.meta && menu.meta.i18n && lang) {
    return menu.meta.i18n['lang'] || menu.name
    // console.log(i18n.$t(menu.meta.i18n));
  }
  return menu.name
}
...
export { parseRoutes, loadRoutes, formatAuthority, getI18nKey, getI18n, loadGuards }
